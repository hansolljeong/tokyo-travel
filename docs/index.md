...
2026년 9월 18일 금요일부터 9월 22일 화요일까지, 남자 2명이 함께 가는 도쿄 여행 문서입니다.
...
- 일정: 2026-09-18 금요일부터 2026-09-22 화요일까지 4박 5일
- 인원: 남자 2명
- 항공: 인천 ICN 출발, 나리타 NRT 도착 및 귀국
- 메인 이벤트: 2026-09-19 토요일, 2026-09-20 일요일 Ultra Japan 2026
- 숙소:
  - 9/18: 소테츠 프레사 다이몬
  - 9/19-9/20: 그랜드 닛코 도쿄 다이바
  - 9/21: 도미인 익스프레스 메구로 아오바다이 핫스프링

## 운영 방식

이 문서는 여행 전에 확정 정보를 모으고, 여행 중에는 빠르게 판단하기 위한 knowledge base입니다.

- `확정`: 예약, 티켓, 시간처럼 실제로 정해진 정보
- `후보`: 가고 싶지만 컨디션과 동선에 따라 고를 장소
- `체크 필요`: 운영시간, 예약, 입장 규정처럼 출발 직전에 다시 확인할 것
- `현지 결정`: 날씨, 피로도, Ultra Japan 이후 체력에 맞춰 고를 것

## 이번 여행의 기본 방향

- 9/19-9/20은 Ultra Japan 중심으로 체력을 배분
